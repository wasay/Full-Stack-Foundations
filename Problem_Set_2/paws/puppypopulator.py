...
from database_setup import Shelters, Base, Puppies, engine
...
puppy_images = ["http://pixabay.com/get/da0c8c7e4aa09ba3a353/1433170694/"
                ...
                "pug-690566_1280.jpg?direct", "http://pixabay.com/get/"
                "be6ebb661e44f929e04e/1433170798/pet-423398_1280.jpg?direct",
                "http://pixabay.com/static/uploads/photo/2010/12/13/10/20/"
                "beagle-puppy-2681_640.jpg", "http://pixabay.com/get/"
                "4b1799cb4e3f03684b69/1433170894/dog-589002_1280.jpg?direct",
                "http://pixabay.com/get/3157a0395f9959b7a000/1433170921/"
                "puppy-384647_1280.jpg?direct", "http://pixabay.com/get/"
                "2a11ff73f38324166ac6/1433170950/puppy-742620_1280.jpg?direct",
                "http://pixabay.com/get/7dcd78e779f8110ca876/1433170979/"
                "dog-710013_1280.jpg?direct", "http://pixabay.com/get/"
                "31d494632fa1c64a7225/1433171005/dog-668940_1280.jpg?direct"]
...
for i, x in enumerate(male_names):
    new_puppy = Puppies(id=None, name=x, gender="male", dateOfBirth=CreateRandomAge(),
...
for i, x in enumerate(female_names):
    new_puppy = Puppies(id=None, name=x, gender="female", dateOfBirth=CreateRandomAge(),
                      picture=random.choice(puppy_images),
                      shelter_id=randint(1, 5), weight=CreateRandomWeight())
    session.add(new_puppy)
    session.commit()
